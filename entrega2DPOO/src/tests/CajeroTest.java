...
class CajeroTest {
	...
	Cajero crearCajeroCafeteria() {
		...
		Cajero cajero = new Cajero ("Tulio Triviño", "ttlogin", "12345678", 175, 56, "Titirilquen", parque.getCafeteria("Juan Valdez"));
		return cajero;
	}
	
	Cajero crearCajeroTienda() {
		Cajero.parque = parque;
		Cajero cajero = new Cajero ("Tulio Triviño", "ttlogin", "12345678", 175, 56, "Titirilquen", parque.getTienda("Cachivaches"));
		return cajero;
	}
